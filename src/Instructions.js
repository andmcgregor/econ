...
var Instructions = React.createClass({
  ...
  render() {
    return <div className="instructions">
             <p>Visualize international trade in goods, as classified by the <a href="https://en.wikipedia.org/wiki/Harmonized_System" target="_blank">Harmonized System (HS)</a>.</p>
